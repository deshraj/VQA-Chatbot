...
function TorchModel:predict(input_image_path, input_sz, input_sz, input_question, input_answer, out_path)
  ...
  print("SVQA answer: ", input_answer)
  -- Set gradInput
  ...
  image.save(out_path .. 'svqa_gcam_raw_' .. input_answer .. '.png', image.toDisplayTensor(gcam))
  result['svqa_gcam_raw'] = out_path .. 'svqa_gcam_raw_' .. input_answer .. '.png'

  image.save(out_path .. 'svqa_gcam_' .. input_answer .. '.png', image.toDisplayTensor(hm))
  result['svqa_gcam'] = out_path .. 'svqa_gcam_' .. input_answer .. '.png'
  ...
  image.save(out_path .. 'svqa_gb_' .. input_answer .. '.png', image.toDisplayTensor(gb_viz))
  result['svqa_gb'] = out_path .. 'svqa_gb_' .. input_answer .. '.png'

  -- Guided Grad-CAM
  local gb_gcam = gb_viz:float():cmul(gcam:expandAs(gb_viz))
  image.save(out_path .. 'svqa_gb_gcam_' .. input_answer .. '.png', image.toDisplayTensor(gb_gcam))
  result['svqa_gb_gcam'] = out_path .. 'svqa_gb_gcam_' .. input_answer .. '.png'
