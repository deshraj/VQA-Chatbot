...
function utils.computeLhood(words, predProbs)
    ...
    -- local predVec = predProbs[{{2,17},{},{}}]:view(-1, predProbs:size(3));
...
function utils.processRanks(ranks)
    ...
    -- TODO: fixed for now, need to make this implicit
    local numOptions = 100;--ranks:size(2);
